$(document).ready(function(){ 
	...
	var logDiv = $("<div>");
	$(logDiv).appendTo("body").attr("class","logDiv").css("position","absolute").css("width","431px").css("height","598px").css("top","80px").css("left","865px")/*.css("border","3px solid red")*/;
	...
	var logForm = $("<form>");
	$(logForm).appendTo(logDiv).css("position","relative").css("width","431px").css("height","305px")/*.css("border","3px solid blue")*/;
	...
	$(rectEmail).appendTo(logForm).css("width","100%").css("height","2px").css("background-color","black");
	...
	$(rectPassword).appendTo(logForm).css("width","100%").css("height","2px").css("background-color","#000000");
	...
	var checkLabel = $('<a></a>');
	$(checkLabel).appendTo(logForm).attr("href","").css("text-decoration","none").css("color","black").text("Forgot password ?").css("margin-left","48%").css("margin-top","30px").css("line-height","18px").css("font-family","Poppins").css("font-weight","300").css("font-size","12px");
	...
	var imgEmail = $('<img>');
	$(imgEmail).appendTo(logForm).css("position","relative").css("top","-306px").css("left","0px").attr("src","msg.png");

	var imgLock = $('<img>');
	$(imgLock).appendTo(logForm).css("position","relative").css("top","-186px").css("left","-14px").attr("src","lock.png");
});
